...
def main():
    ...
    print('Updating coder.pt with def file')

    search_packages = {

        'coderdef': {
            'name': 'coder.def',
            'source': os.path.join ( PTSRC, 'coder', 'coder.def' ),
            'range_strs': [
    ...
    with open( os.path.join(PTSRC, 'coder', 'coder.pt'), 'r') as pf:
    ...
    with open( os.path.join(PTSRC, 'coder', 'coder.pt'), 'w' ) as tf:
